...
from .models import Binnacle, Category, Company, CreditNote, Customer, Department, Diesel, Employee, FileProducer, FuelType, Fueling, Gasoline, InitialCash, Location, MainPresentation, MainProduct, Parcel, Presentation, Producer, Product, ProductCN, ProductW, Provider, Requisition, SegalmexParcel, SegalmexReception, Shopping, Unit, User, Bank, BankAccount, Variety, VehicleType, Warehouse
...
admin.site.register(MainPresentation)
