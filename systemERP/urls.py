...
#*? DEPARTAMENTOS
    ...
    path('ReportDepartmentsPDF', views.ReportDepartmentsPDF.as_view(), name='ReportDepartmentsPDF'),
    path('ReportDepartmentsXLSX', views.ReportDepartmentsXLSX.as_view(), name='ReportDepartmentsXLSX'), 
#*? CATEGORIAS
    ...
    path('ReportCategoriesPDF', views.ReportCategoriesPDF.as_view(), name='ReportCategoriesPDF'),
    path('ReportCategoriesXLSX', views.ReportCategoriesXLSX.as_view(), name='ReportCategoriesXLSX'), 
#*? BANCOS
...
#*? CUENTAS DE BANCOS
    ...
    path('BankAccountDetail/<str:pk>', views.BankAccountDetail, name="BankAccountDetail"),
    path('BankAccountCreate', views.BankAccountCreate, name="BankAccountCreate"),
    path('BankAccountUpdate/<str:pk>', views.BankAccountUpdate, name="BankAccountUpdate"),
    path('BankAccountDelete/<str:pk>', views.BankAccountDelete, name="BankAccountDelete"),
...
#*? REQUISITION   
    ...
    path('DeleteRequisition/<str:pk>',views.DeleteRequisition, name="DeleteRequisition"),
    path('RequisitionDetail/<str:pk>',views.RequisitionDetail, name="RequisitionDetail"),
...
#*? PRODUCTOS
    ...
    path('ReportProductsPDF', views.ReportProductsPDF.as_view(), name='ReportProductsPDF'),  
    path('ReportProductsXLSX', views.ReportProductsXLSX.as_view(), name='ReportProductsXLSX'),      
#*? PRESENTACIONES
    ...
    path('DeletePresentation/<str:pk>',views.DeletePresentation, name="DeletePresentation"),
    path('PresentationDetail/<str:pk>',views.PresentationDetail, name="PresentationDetail"),
    path('UpdatePresentation/<str:pk>',views.UpdatePresentation, name="UpdatePresentation"),
    path('ReportPresentationsPDF', views.ReportPresentationsPDF.as_view(), name='ReportPresentationsPDF'),  
    path('ReportPresentationsXLSX', views.ReportPresentationsXLSX.as_view(), name='ReportPresentationsXLSX'),  
...
#*? SEGALMEX parcelas
    ...
    path('CreateSegalmexParcel',views.CreateSegalmexParcel, name="CreateSegalmexParcel"),
    path('DeleteSegalmexParcel/<str:pk>',views.DeleteSegalmexParcel, name="DeleteSegalmexParcel"),
    path('DetailSegalmexParcel/<str:pk>',views.DetailSegalmexParcel, name="DetailSegalmexParcel"),
    path('UpdateSegalmexParcel/<str:pk>',views.UpdateSegalmexParcel, name="UpdateSegalmexParcel"),
    path('ReportSegalmexParcelsPDF', views.ReportSegalmexParcelsPDF.as_view(), name='ReportSegalmexParcelsPDF'),  
    path('ReportSegalmexParcelsXLSX', views.ReportSegalmexParcelsXLSX.as_view(), name='ReportSegalmexParcelsXLSX'),     

#*? SEGALMEX recepción

    path('ListSegalmexReception',views.ListSegalmexReception, name="ListSegalmexReception"),
    path('CreateSegalmexReception',views.CreateSegalmexReception, name="CreateSegalmexReception"),
...
#*? ORDEN DE PAGO DE PROVEEDORES
    path('SearchTicketReception',views.SearchTicketReception, name="SearchTicketReception"),
    path('ListPaymentOrderProducer',views.ListPaymentOrderProducer, name="ListPaymentOrderProducer"),
    path('CreatePaymentOrderProducer',views.CreatePaymentOrderProducer, name="CreatePaymentOrderProducer"),
    path('DeletePaymentOrderProducer/<str:pk>',views.DeletePaymentOrderProducer, name="DeletePaymentOrderProducer"),
    path('DetailPaymentOrderProducer/<str:pk>',views.DetailPaymentOrderProducer, name="DetailPaymentOrderProducer"),
    path('UpdatePaymentOrderProducer/<str:pk>',views.UpdatePaymentOrderProducer, name="UpdatePaymentOrderProducer"), 

#*? PAGO DE PROVEEDORES
    path('SearchPaymentOrderProducer',views.SearchPaymentOrderProducer, name="SearchPaymentOrderProducer"),
    path('ListPaymentProducer',views.ListPaymentProducer, name="ListPaymentProducer"),
    path('CreatePaymentProducer',views.CreatePaymentProducer, name="CreatePaymentProducer"),
    path('DeletePaymentProducer/<str:pk>',views.DeletePaymentProducer, name="DeletePaymentProducer"),
    path('DetailPaymentProducer/<str:pk>',views.DetailPaymentProducer, name="DetailPaymentProducer"),
    path('UpdatePaymentProducer/<str:pk>',views.UpdatePaymentProducer, name="UpdatePaymentProducer"),   
...
#*? Salario de choferes
    ...
    path('DeleteDriverSalary/<str:pk>',views.DeleteDriverSalary, name="DeleteDriverSalary"),
    path('DetailDriverSalary/<str:pk>',views.DetailDriverSalary, name="DetailDriverSalary"),
    path('UpdateDriverSalary/<str:pk>',views.UpdateDriverSalary, name="UpdateDriverSalary"),   
#*? Salario de cargadores
    ...
    path('DeleteChargerSalary/<str:pk>',views.DeleteChargerSalary, name="DeleteChargerSalary"),
    path('DetailChargerSalary/<str:pk>',views.DetailChargerSalary, name="DetailChargerSalary"),
    path('UpdateChargerSalary/<str:pk>',views.UpdateChargerSalary, name="UpdateChargerSalary"),
...
#*? Prestamos Cargadores
    ...
    path('DeleteLoansChargers/<str:pk>',views.DeleteLoansChargers, name="DeleteLoansChargers"),
#*? Abono Cargadores 
    path('ListPaymentsChargers',views.ListPaymentsChargers, name="ListPaymentsChargers"),
...
#*? Prestamos Choferes
    ...
    path('DeleteLoansDrivers/<str:pk>',views.DeleteLoansDrivers, name="DeleteLoansDrivers"),  
#*? Abonos Choferes
    path('ListPaymentsDrivers',views.ListPaymentsDrivers, name="ListPaymentsDrivers"),
    path('CreatePaymentsDrivers',views.CreatePaymentsDrivers, name="CreatePaymentsDrivers"),
...
#*? Crear Cuuenta de Banco de clientes
    path('CreateBankAccountsCustomer',views.CreateBankAccountsCustomer, name="CreateBankAccountsCustomer"),
    path('ListBankAccountsCustomer/<str:pk>',views.ListBankAccountsCustomer, name="ListBankAccountsCustomer"),  
#*? Crear Cuuenta de Banco de Empleados
    path('CreateBankAccountsEmployee',views.CreateBankAccountsEmployee, name="CreateBankAccountsEmployee"),
    path('ListBankAccountsEmployee/<str:pk>',views.ListBankAccountsEmployee, name="ListBankAccountsEmployee"),
...
#*? CONTROL DE DEPOSITOS
    path('CreateDepositControl',views.CreateDepositControl, name="CreateDepositControl"),
